 ...
 */
function vanderlaat_preprocess_html(&$variables) {
  $meta_charset = array(
    '#tag' => 'meta',
    '#attributes' => array(
      'charset' => 'utf-8',
    ...
    $element = array(
      'element' => array(
        ...
        '#attributes' => array(
          ...
          'src' => file_create_url(drupal_get_path('theme', 'vanderlaat') . '/js/html5shiv-printshiv.js'),
        ),
      ),
    );
    $html5shim = array(
  ...
  if (theme_get_setting('respond_js')) {
    drupal_add_js(drupal_get_path('theme', 'vanderlaat') . '/js/respond.min.js', array('group' => JS_LIBRARY, 'weight' => -100));
  }
 ...
 */
function vanderlaat_html_head_alter(&$head_elements) {
 ...
 */
function vanderlaat_page_alter(&$page) {
...
function vanderlaat_preprocess_node(&$vars) {
  // Add a striping class.
  $vars['classes_array'][] = 'node-' . $vars['zebra'];
}

function vanderlaat_preprocess_block(&$vars, $hook) {
  // Add a striping class.
